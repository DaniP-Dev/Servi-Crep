...
export const metadata: Metadata = {
  title: {
    default: "ServiCrep - Servicios de Reparación",
    template: "%s | ServiCrep"
  },
  description: "Servicios profesionales de reparación, mantenimiento y soluciones técnicas especializadas. Expertos en reparación de electrodomésticos, equipos electrónicos y sistemas técnicos.",
  keywords: [
    "reparación", 
    "mantenimiento", 
    "servicios técnicos", 
  ...
  metadataBase: new URL('https://www.servicrep.com'),
  alternates: {
    canonical: '/',
    languages: {
      'es-ES': '/',
  ...
  openGraph: {
    ...
    siteName: 'ServiCrep',
    title: 'ServiCrep - Servicios de Reparación Profesional',
    description: 'Servicios profesionales de reparación, mantenimiento y soluciones técnicas especializadas. Técnicos expertos, garantía y servicio a domicilio.',
    images: [
      {
  ...
  archives: ['https://www.servicrep.com/sitemap.xml'],
  assets: ['https://www.servicrep.com/assets'],
  bookmarks: ['https://www.servicrep.com/favoritos'],
  other: {
    'theme-color': '#ffffff',
    ...
    'msapplication-tooltip': 'Servicios de Reparación ServiCrep',
    'msapplication-starturl': '/',
    'msapplication-navbutton-color': '#ffffff',
    'msapplication-window': 'width=1024;height=768',
    'msapplication-task': 'name=Servicios;action-uri=/servicios;icon-uri=/favicon.ico',
    ...
    'ICBM': '40.4168,-3.7038',
    'DC.title': 'ServiCrep - Servicios de Reparación',
    'DC.creator': 'ServiCrep',
    'DC.subject': 'Servicios de Reparación',
    'DC.description': 'Servicios profesionales de reparación y mantenimiento',
    'DC.publisher': 'ServiCrep',
    'DC.contributor': 'ServiCrep Team',
    'DC.date': '2025',
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.servicrep.com',
    'DC.source': 'https://www.servicrep.com',
    'DC.language': 'es',
    'DC.relation': 'https://www.servicrep.com',
    'DC.coverage': 'España',
      ...
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
        ...
        <Script id="structured-data" type="application/ld+json">
          {JSON.stringify({
            ...
            "serviceType": "Reparación y Mantenimiento",
            "areaServed": "España",
            "priceRange": "€€"
          })}
        </Script>
