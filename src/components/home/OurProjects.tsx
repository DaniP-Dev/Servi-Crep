...
const ourProjectsTexts = {
  ...
  sectionDescription:
    "Con nuestra verificación imparcial, Explora casos reales: antes/después de inspecciones que protegen tu legado.",
  tabs: [
    {
      id: 1,
        ...
        <div className="row g-5">
          <div className="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
            <div>
              ...
              <h2 className="display-4 mb-4 text-secondary">
                {ourProjectsTexts.sectionSubtitle}
              </h2>
              ...
              <ul className="nav">
                {ourProjectsTexts.tabs.map((tab, idx) => (
                  <li className={`nav-item bg-white mb-4 w-100`} key={tab.id}>
                    <a
                      className={`d-flex align-items-center h4 mb-0 p-3${idx === 0 ? " active" : ""}`}
                      data-bs-toggle="pill"
                      href={`#ProjectsTab-${tab.id}`}
                    >
                ...
                >
                  <div className="projects-item">
                    ...
                    <div className="projects-content bg-white p-4">
                      <h4 className="mb-3">
                        {ourProjectsTexts.projects[idx].title}
                      </h4>
                      <p className="mb-4">
                        {ourProjectsTexts.projects[idx].desc}
                      </p>
                      <div className="d-flex gap-2 flex-wrap">
                        <a
                          className="btn btn-primary py-2 px-4"
                          href={ourProjectsTexts.projects[idx].cta.href}
                        >
