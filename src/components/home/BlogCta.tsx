            ...
            <div className="blog-item">
              <div className="blog-img">
                <Image
                  ...
                  alt="Artículo sobre inspección técnica y energía"
                  width={800}
                  height={500}
            ...
            <div className="blog-item">
              <div className="blog-img">
                <Image
                  ...
                  className="img-fluid w-100"
                  alt="Artículo sobre servicios energéticos e inspección"
                  width={800}
                  height={500}
                  sizes="(max-width: 992px) 100vw, 33vw"
                />
            ...
            <div className="blog-item">
              <div className="blog-img">
                <Image
                  ...
                  className="img-fluid w-100"
                  alt="Artículo sobre el futuro de la energía e inspección"
                  width={800}
                  height={500}
                  sizes="(max-width: 992px) 100vw, 33vw"
                />
